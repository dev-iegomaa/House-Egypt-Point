                        ...
                        <div class="widget-content">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                    <tr>
                                        <td><div class="td-content customer-name"><img src="{{ asset('dashboard/assets/img/90x90.jpg') }}" alt="avatar">Andy King</div></td>
                                    ...
                                    <tr>
                                        <td><div class="td-content customer-name"><img src="{{ asset('dashboard/assets/img/90x90.jpg') }}" alt="avatar">Irene Collins</div></td>
                                    ...
                                    <tr>
                                        <td><div class="td-content customer-name"><img src="{{ asset('dashboard/assets/img/90x90.jpg') }}" alt="avatar">Laurie Fox</div></td>
                                    ...
                                    <tr>
                                        <td><div class="td-content customer-name"><img src="{{ asset('dashboard/assets/img/90x90.jpg') }}" alt="avatar">Luke Ivory</div></td>
                                    ...
                                    <tr>
                                        <td><div class="td-content customer-name"><img src="{{ asset('dashboard/assets/img/90x90.jpg') }}" alt="avatar">Ryan Collins</div></td>
                                    ...
                                    <tr>
                                        <td><div class="td-content customer-name"><img src="{{ asset('dashboard/assets/img/90x90.jpg') }}" alt="avatar">Nia Hillyer</div></td>
                                    ...
                                    <tr>
                                        <td><div class="td-content customer-name"><img src="{{ asset('dashboard/assets/img/90x90.jpg') }}" alt="avatar">Sonia Shaw</div></td>
                        ...
                        <div class="widget-content">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                    <tr>
                                        <td><div class="td-content product-name"><img src="{{ asset('dashboard/assets/img/90x90.jpg') }}" alt="product">Speakers</div></td>
                                    ...
                                    <tr>
                                        <td><div class="td-content product-name"><img src="{{ asset('dashboard/assets/img/90x90.jpg') }}" alt="product">Sunglasses</div></td>
                                    ...
                                    <tr>
                                        <td><div class="td-content product-name"><img src="{{ asset('dashboard/assets/img/90x90.jpg') }}" alt="product">Watch</div></td>
                                    ...
                                    <tr>
                                        <td><div class="td-content product-name"><img src="{{ asset('dashboard/assets/img/90x90.jpg') }}" alt="product">Laptop</div></td>
                                    ...
                                    <tr>
                                        <td><div class="td-content product-name"><img src="{{ asset('dashboard/assets/img/90x90.jpg') }}" alt="product">Camera</div></td>
                                    ...
                                    <tr>
                                        <td><div class="td-content product-name"><img src="{{ asset('dashboard/assets/img/90x90.jpg') }}" alt="product">Shoes</div></td>
                                    ...
                                    <tr>
                                        <td><div class="td-content product-name"><img src="{{ asset('dashboard/assets/img/90x90.jpg') }}" alt="product">Headphone</div></td>
