                            ...
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                        <h4>Property Summary Edit</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="widget-content widget-content-area">
                                <form action="{{ route('admin.property-summary.update') }}" method="post">
                                    @method('PUT')
                                    @include('pages.property_summary._form')
                                    <input type="hidden" name="id" value="{{ $property_summary->id }}">
