                            ...
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                        <h4>Property General Edit</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="widget-content widget-content-area">
                                <form action="{{ route('admin.property-general.update') }}" method="post">
                                    @method('PUT')
                                    @include('pages.property_general._form')
                                    <input type="hidden" name="id" value="{{ $property_general->id }}">
